...
# Arbre de Décision
tree_classifier = DecisionTreeClassifier(random_state=125)
...
probabilities = tree_classifier.predict_proba(X_test)[:, 1]
...
plot_confusion_matrix(y_test, probabilities, threshold=0.5)
